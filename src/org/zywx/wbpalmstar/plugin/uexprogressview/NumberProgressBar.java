...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, EUExUtil.getResAttrID("numberProgressBarStyle"));
    }
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_progress_text_offset = dp2px(10.0f);
    ...
    private void calculateDrawRectF(){
        ...
        if(getProgress() == 0){
            ...
            mReachedRectF.left = getPaddingLeft();
            mReachedRectF.top = getHeight()/2.0f - mReachedBarHeight / 2.0f;
            mReachedRectF.right = (getWidth() - getPaddingLeft() - getPaddingRight() -mDrawTextWidth - mOffset)/(getMax()*1.0f) * getProgress() + getPaddingLeft();
            mReachedRectF.bottom = getHeight()/2.0f + mReachedBarHeight / 2.0f;
            mDrawTextStart = getWidth() - getPaddingRight() - mDrawTextWidth;
        }
        ...
        float unreachedBarStart = getProgress() == 0 ? getPaddingLeft() : mReachedRectF.right;
        if(unreachedBarStart >= getWidth() - getPaddingRight() - mDrawTextWidth - mOffset){
