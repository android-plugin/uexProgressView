...
public class RoundProgressBar extends View {
	 ...
	 * 圆环中间底部颜色
	 */
	private int cireBackroundColor;
	...
	public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		style = 0;
		cireBackroundColor = getResources().getColor(android.R.color.white);
//		mTypedArray.recycle();
	}
	...
	protected void onDraw(Canvas canvas) {
		 ...
		 * 设置中间背景
		 */
		int radius2 = (int) (centre - roundWidth); //中间圆环的半径
		paint.setColor(cireBackroundColor); //设置圆环的颜色
		...
		case STROKE:{
			...
			RectF oval = new RectF(centre - radius+roundWidth/2, centre - radius+roundWidth/2, centre
					+ radius-roundWidth/2, centre + radius-roundWidth/2);  //用于定义的圆弧的形状和大小的界限
	...
	public int getCireBackroundColor() {
		return cireBackroundColor;
	}

	public void setCireBackroundColor(int cireBackroundColor) {
		this.cireBackroundColor = cireBackroundColor;
	}
